        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="surat-file-tanggapan-form" name="surat-file-tanggapan-form"  method="POST"  role="form" enctype="multipart/form-data" class="dropzone">
                    <?php echo csrf_field(); ?>
                    <?php echo Form::hidden('id', '', ['id'=>'surat-file-tanggapan-id']); ?>

                    <?php echo Form::hidden('id_surat_masuk', '', ['id'=>'surat-file-tanggapan-id_surat_masuk']); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views/surat/file-tanggapan/index.blade.php ENDPATH**/ ?>