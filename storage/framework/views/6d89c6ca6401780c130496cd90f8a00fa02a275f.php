...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6" id="card_title"><?php echo e(__('Disposisi Surat')); ?></div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.disposisi_surat-edit', function () {
        ...
        $.get("<?php echo e(route('disposisi_surat.index')); ?>" +'/' + disposisi_surat_id +'/edit', function (data) {
    ...
    $('body').on('click', '.disposisi_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('disposisi_surat.store')); ?>"+'/'+disposisi_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\__BACKUP\disposisi-surat\index.blade.php ENDPATH**/ ?>