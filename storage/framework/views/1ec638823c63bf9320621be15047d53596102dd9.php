<div class="row mb-3">
    <div class="col-md-6" id="card_title"><?php echo e(Form::label('daftar_dokumen_surat')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="surat-dokumen-surat-form" name="surat-dokumen-surat-form"  method="POST"  role="form" enctype="multipart/form-data" class="dropzone">
                    <?php echo csrf_field(); ?>
                    <?php echo Form::hidden('id', '', ['id'=>'surat-dokumen-surat-id']); ?>

                    <?php echo Form::hidden('id_surat_masuk', '', ['id'=>'surat-dokumen-surat-id_surat_masuk']); ?>
...
$(function () {
    ...
    $('body').on('click', '.surat-dokumen-surat-edit', function () {
        ...
        $.get('<?php echo e(route('dokumen_surat.index')); ?>' + '/' + surat_dokumen_surat_id  + '/edit', function (data) {
            reset_form_data('#surat-dokumen-surat-form');
    ...
    $('body').on('click', '.surat-dokumen-surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: '<?php echo e(route('dokumen_surat.store')); ?>' + '/' + surat_dokumen_surat_id,
                success: function (data) {
                    surat_dokumen_surat_table.ajax.url( '<?php echo e(route( 'dokumen_surat.index' )); ?>?id_surat_masuk=' + surat_masuk_id ).load();
                },
                error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\dokumen-surat\index.blade.php ENDPATH**/ ?>