        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Master Jenis File')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="master_jenis_file-form" name="master_jenis_file-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('sambung.master-jenis-file.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var master_jenis_file_table = $('#master_jenis_file-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('master_jenis_file.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.master_jenis_file-edit', function () {
        ...
        $.get("<?php echo e(route('master_jenis_file.index')); ?>" +'/' + master_jenis_file_id +'/edit', function (data) {
    ...
    $('#master_jenis_file-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('master_jenis_file.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.master_jenis_file-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('master_jenis_file.store')); ?>"+'/'+master_jenis_file_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\sambung\master-jenis-file\index.blade.php ENDPATH**/ ?>