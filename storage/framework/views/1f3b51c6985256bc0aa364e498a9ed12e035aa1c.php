        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('File Kegiatan')); ?></div>
...
<script type="text/javascript">
    ...
    var file_kegiatan_table = $('#file_kegiatan-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('file_kegiatan.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.file_kegiatan-edit', function () {
        ...
        $.get("<?php echo e(route('file_kegiatan.index')); ?>" +'/' + file_kegiatan_id +'/edit', function (data) {
    ...
    $('#file_kegiatan-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('file_kegiatan.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.file_kegiatan-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('file_kegiatan.store')); ?>"+'/'+file_kegiatan_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\sambung\file-kegiatan\index.blade.php ENDPATH**/ ?>