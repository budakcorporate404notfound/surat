        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Arahan Surat')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="arahan_surat-form" name="arahan_surat-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('surat.arahan-surat.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var arahan_surat_table = $('#arahan_surat-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('arahan_surat.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.arahan_surat-edit', function () {
        ...
        $.get("<?php echo e(route('arahan_surat.index')); ?>" +'/' + arahan_surat_id +'/edit', function (data) {
    ...
    $('#arahan_surat-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('arahan_surat.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.arahan_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('arahan_surat.store')); ?>"+'/'+arahan_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\arahan-surat\index.blade.php ENDPATH**/ ?>