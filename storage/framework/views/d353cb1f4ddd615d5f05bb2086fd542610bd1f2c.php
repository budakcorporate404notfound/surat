<div class="row mb-3">
    <div class="col-md-6" id="card_title"><?php echo e(Form::label('daftar_disposisi_dari_pimpinan')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="surat-disposisi-pimpinan-form" name="surat-disposisi-pimpinan-form"  method="POST"  role="form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo Form::hidden('id', '', ['id'=>'surat-disposisi-pimpinan-id']); ?>

                    <?php echo Form::hidden('id_surat_masuk', '', ['id'=>'surat-disposisi-pimpinan-id_surat_masuk']); ?>

                    <?php echo $__env->make('surat.disposisi-pimpinan.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(function () {
    ...
    surat_disposisi_pimpinan_table = $('#surat-disposisi-pimpinan-data-table').DataTable({
        ...
        searching: false,
        info: false,
        ajax: "<?php echo e(route('disposisi_pimpinan.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.surat-disposisi-pimpinan-edit', function () {
        ...
        $.get('<?php echo e(route('disposisi_pimpinan.index')); ?>' + '/' + surat_disposisi_pimpinan_id  + '/edit', function (data) {
            reset_form_data('#surat-disposisi-pimpinan-form');
    ...
    $('#surat-disposisi-pimpinan-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('disposisi_pimpinan.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.surat-disposisi-pimpinan-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: '<?php echo e(route('disposisi_pimpinan.store')); ?>' + '/' + surat_disposisi_pimpinan_id,
                success: function (data) {
                    surat_disposisi_pimpinan_table.ajax.url( '<?php echo e(route( 'disposisi_pimpinan.index' )); ?>?id_surat_masuk=' + surat_masuk_id ).load();
                },
                error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\disposisi-pimpinan\index.blade.php ENDPATH**/ ?>