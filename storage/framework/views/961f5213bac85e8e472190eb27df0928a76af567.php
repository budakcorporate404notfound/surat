        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Unit')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="unit-form" name="unit-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('surat.unit.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.unit-edit', function () {
        ...
        $.get("<?php echo e(route('unit.index')); ?>" +'/' + unit_id +'/edit', function (data) {
    ...
    $('body').on('click', '.unit-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('unit.store')); ?>"+'/'+unit_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\unit\index.blade.php ENDPATH**/ ?>