        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Master Jenis Status')); ?></div>
...
<script type="text/javascript">
    ...
    var master_jenis_status_table = $('#master_jenis_status-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('master_jenis_status.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.master_jenis_status-edit', function () {
        ...
        $.get("<?php echo e(route('master_jenis_status.index')); ?>" +'/' + master_jenis_status_id +'/edit', function (data) {
    ...
    $('#master_jenis_status-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('master_jenis_status.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.master_jenis_status-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('master_jenis_status.store')); ?>"+'/'+master_jenis_status_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\sambung\master-jenis-status\index.blade.php ENDPATH**/ ?>