...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6" id="card_title"><?php echo e(__('Disposisi Pimpinan')); ?></div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.disposisi_pimpinan-edit', function () {
        ...
        $.get("<?php echo e(route('disposisi_pimpinan.index')); ?>" +'/' + disposisi_pimpinan_id +'/edit', function (data) {
    ...
    $('body').on('click', '.disposisi_pimpinan-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('disposisi_pimpinan.store')); ?>"+'/'+disposisi_pimpinan_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\__BACKUP\disposisi-pimpinan\index.blade.php ENDPATH**/ ?>