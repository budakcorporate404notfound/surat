        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Master Model Tahapan')); ?></div>
...
<script type="text/javascript">
    ...
    var master_model_tahapan_table = $('#master_model_tahapan-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('master_model_tahapan.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.master_model_tahapan-edit', function () {
        ...
        $.get("<?php echo e(route('master_model_tahapan.index')); ?>" +'/' + master_model_tahapan_id +'/edit', function (data) {
    ...
    $('#master_model_tahapan-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('master_model_tahapan.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.master_model_tahapan-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('master_model_tahapan.store')); ?>"+'/'+master_model_tahapan_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\sambung\master-model-tahapan\index.blade.php ENDPATH**/ ?>