...
<form action="<?php echo e(route('jenisFile.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline"><input class="form-check-input" type="radio" id="id_jenis_surat1" name="id_jenis_surat" value="1"><label class="form-check-label" for="id_jenis_surat1">(SD) Surat Dinas</label></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nomor_surat" id="nomor_surat" placeholder="Nomor surat masuk" autofocus>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nomor_surat">Tanggal</label>
                                <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" name="tanggal_surat" id="tanggal_surat" placeholder="Tanggal surat masuk">
                            </div>
                        </div>
                    </div>
                    <div class="form-group"><label for="kepada">Kepada</label><input type="text" class="form-control" name="kepada" id="kepada" placeholder="Kepada"></div>
                    <div class="form-group"><label for="perihal">Perihal</label><input type="text" class="form-control" name="perihal" id="perihal" placeholder="Perihal"></div>
                    <div class="form-group"><label for="asal_surat_masuk">Asal surat masuk</label><input type="text" class="form-control" name="asal_surat_masuk" id="asal_surat_masuk" placeholder="Asal surat masuk"></div>
                    <div class="form-group"><label for="pejabat_pengirim_surat">Pejabat pengirim surat</label><input type="text" class="form-control" name="pejabat_pengirim_surat" id="pejabat_pengirim_surat" placeholder="Pejabat pengirim surat"></div>
                    <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="jenis_file" class="form-control" placeholder="Jenis file">
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat_ASLI_LAMA\jenisFile\create.blade.php ENDPATH**/ ?>