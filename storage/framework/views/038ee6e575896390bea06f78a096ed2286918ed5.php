...
$(function () {
    ...
    <?php $Surat = app('App\Http\Controllers\Surat\SuratController'); ?>

    surat_jenis_dokumens = <?php echo json_encode($Surat::convertToJsVar($jenis_dokumens, 'jenis_dokumen')); ?>;
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\surat-keluar\index-full.blade.php ENDPATH**/ ?>