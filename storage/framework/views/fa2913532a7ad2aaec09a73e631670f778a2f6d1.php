    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document" style="min-width:75%; max-width:95%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo $__env->make('surat.status-mailbox.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
...
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\status-mailbox\modal.blade.php ENDPATH**/ ?>