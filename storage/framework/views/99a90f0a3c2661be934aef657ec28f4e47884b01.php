<div id="surat-surat-keluar-data-table-pos">
    <div id="surat-surat-keluar-data-block">
        <div class="row mb-3">
            <div class="col-md-6" id="card_title"><?php echo e(Form::label('daftar_lampiran_tanggapan_surat')); ?></div>
            <div class="col-md-6 text-right">
                <a class="btn btn-outline-success" href="javascript:void(0)" id="surat-tanggapan-surat-create-new"><i class="fas fa-plus-circle"></i> Tambah file lampiran</a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body col-md-12">
                <table class="table table-bordered data-table dt-responsive nowrap" id="surat-surat_keluar-data-table">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="surat_keluar-form" name="surat_keluar-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo Form::hidden('id_surat_masuk', '', ['id'=>'surat-surat-keluar-id_surat_masuk']); ?>
...
<script type="text/javascript">
    ...
    var surat_surat_keluar_table = $('#surat-surat_keluar-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('surat_keluar.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.surat_keluar-edit', function () {
        ...
        $.get("<?php echo e(route('surat_keluar.index')); ?>" +'/' + surat_keluar_id +'/edit', function (data) {
    ...
    $('#surat_keluar-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('surat_keluar.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.surat_keluar-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('surat_keluar.store')); ?>"+'/'+surat_keluar_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\__BACKUP\DELETE_konsep-surat-keluar\index.blade.php ENDPATH**/ ?>