        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Jenis Disposisi')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="jenis_disposisi-form" name="jenis_disposisi-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('surat.jenis-disposisi.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var jenis_disposisi_table = $('#jenis_disposisi-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('jenis_disposisi.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.jenis_disposisi-edit', function () {
        ...
        $.get("<?php echo e(route('jenis_disposisi.index')); ?>" +'/' + jenis_disposisi_id +'/edit', function (data) {
    ...
    $('#jenis_disposisi-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('jenis_disposisi.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.jenis_disposisi-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('jenis_disposisi.store')); ?>"+'/'+jenis_disposisi_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\jenis-disposisi\index.blade.php ENDPATH**/ ?>