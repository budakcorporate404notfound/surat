        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Asal Ekspedisi Surat Masuk')); ?></div>
...
<script type="text/javascript">
    ...
    var asal_ekspedisi_surat_masuk_table = $('#asal_ekspedisi_surat_masuk-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('asal_ekspedisi_surat_masuk.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.asal_ekspedisi_surat_masuk-edit', function () {
        ...
        $.get("<?php echo e(route('asal_ekspedisi_surat_masuk.index')); ?>" +'/' + asal_ekspedisi_surat_masuk_id +'/edit', function (data) {
    ...
    $('#asal_ekspedisi_surat_masuk-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('asal_ekspedisi_surat_masuk.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.asal_ekspedisi_surat_masuk-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('asal_ekspedisi_surat_masuk.store')); ?>"+'/'+asal_ekspedisi_surat_masuk_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\asal-ekspedisi-surat-masuk\index.blade.php ENDPATH**/ ?>