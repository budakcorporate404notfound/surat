        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Status Disposisi')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="status_disposisi-form" name="status_disposisi-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('surat.status-disposisi.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var status_disposisi_table = $('#status_disposisi-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('status_disposisi.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.status_disposisi-edit', function () {
        ...
        $.get("<?php echo e(route('status_disposisi.index')); ?>" +'/' + status_disposisi_id +'/edit', function (data) {
    ...
    $('#status_disposisi-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('status_disposisi.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.status_disposisi-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('status_disposisi.store')); ?>"+'/'+status_disposisi_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\status-disposisi\index.blade.php ENDPATH**/ ?>