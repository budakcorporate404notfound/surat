        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title"><?php echo e(__('Memo Disposisi')); ?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="memo_disposisi-form" name="memo_disposisi-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    <?php echo $__env->make('surat.memo-disposisi.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    var memo_disposisi_table = $('#memo_disposisi-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('memo_disposisi.index')); ?>",
        columns: [
    ...
    $('body').on('click', '.memo_disposisi-edit', function () {
        ...
        $.get("<?php echo e(route('memo_disposisi.index')); ?>" +'/' + memo_disposisi_id +'/edit', function (data) {
    ...
    $('#memo_disposisi-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('memo_disposisi.store')); ?>",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.memo_disposisi-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('memo_disposisi.store')); ?>"+'/'+memo_disposisi_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
...
<?php echo $__env->make('adminlte.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\surat\resources\views\surat\memo-disposisi\index.blade.php ENDPATH**/ ?>