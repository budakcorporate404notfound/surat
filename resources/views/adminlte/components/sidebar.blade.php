...
--}}
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link"><i class="nav-icon fas fa-envelope"></i><p>Persuratan<i class="right fas fa-angle-left"></i></p></a>
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="#" data-id="99" class="surat_masuk_link_to nav-link"><i class="far fa-envelope nav-icon"></i><p><span class="badge badge-pill badge-info">All</span></p></a></li>
                <li class="nav-item"><a href="#" data-id="3" class="surat_masuk_link_to nav-link"><i class="far fa-envelope nav-icon"></i><p><span class="badge badge-pill badge-primary">Inbox</span></p></a></li>
                <li class="nav-item"><a href="#" data-id="1" class="surat_masuk_link_to nav-link"><i class="far fa-edit nav-icon"></i><p><span class="badge badge-pill badge-secondary">Draft</span></p></a></li>
                <li class="nav-item"><a href="#" data-id="2" class="surat_masuk_link_to nav-link"><i class="far fa-share-square nav-icon"></i><p><span class="badge badge-pill badge-success">Sent</span></p></a></li>
                <li class="nav-item"><a href="#" data-id="4" class="surat_masuk_link_to nav-link"><i class="far fa-thumbs-up nav-icon"></i><p><span class="badge badge-pill badge-danger">Processed</span></p></a></li>
                <li class="nav-item"><a href="#" data-id="5" class="surat_masuk_link_to nav-link"><i class="far fa-check-circle nav-icon"></i><p><span class="badge badge-pill badge-warning">Signed</span></p></a></li>
{{--
