        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Sifat Keamanan Surat') }}</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="sifat_keamanan_surat-form" name="sifat_keamanan_surat-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    @include('surat.sifat-keamanan-surat.form')
...
<script type="text/javascript">
    ...
    var sifat_keamanan_surat_table = $('#sifat_keamanan_surat-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('sifat_keamanan_surat.index') }}",
        columns: [
    ...
    $('body').on('click', '.sifat_keamanan_surat-edit', function () {
        ...
        $.get("{{ route('sifat_keamanan_surat.index') }}" +'/' + sifat_keamanan_surat_id +'/edit', function (data) {
    ...
    $('#sifat_keamanan_surat-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "{{ route('sifat_keamanan_surat.store') }}",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.sifat_keamanan_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('sifat_keamanan_surat.store') }}"+'/'+sifat_keamanan_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
