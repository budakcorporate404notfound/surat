        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Jenis Dokuman') }}</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="jenis_dokumen-form" name="jenis_dokumen-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    @include('surat.jenis-dokuman.form')
...
<script type="text/javascript">
    ...
    var jenis_dokumen_table = $('#jenis_dokumen-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('jenis_dokumen.index') }}",
        columns: [
    ...
    $('body').on('click', '.jenis_dokumen-edit', function () {
        ...
        $.get("{{ route('jenis_dokumen.index') }}" +'/' + jenis_dokumen_id +'/edit', function (data) {
    ...
    $('body').on('click', '.jenis_dokumen-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('jenis_dokumen.store') }}"+'/'+jenis_dokumen_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
