        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Counter Surat') }}</div>
...
<script type="text/javascript">
    ...
    var counter_surat_table = $('#counter_surat-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('counter_surat.index') }}",
        columns: [
    ...
    $('body').on('click', '.counter_surat-edit', function () {
        ...
        $.get("{{ route('counter_surat.index') }}" +'/' + counter_surat_id +'/edit', function (data) {
    ...
    $('body').on('click', '.counter_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('counter_surat.store') }}"+'/'+counter_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
