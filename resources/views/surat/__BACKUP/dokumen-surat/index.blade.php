...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6" id="card_title">{{ __('Dokumen Surat') }}</div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.dokumen_surat-edit', function () {
        ...
        $.get("{{ route('dokumen_surat.index') }}" +'/' + dokumen_surat_id +'/edit', function (data) {
    ...
    $('body').on('click', '.dokumen_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('dokumen_surat.store') }}"+'/'+dokumen_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
