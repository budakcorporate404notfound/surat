        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Sifat Penyelesaian Surat') }}</div>
...
<script type="text/javascript">
    ...
    var sifat_penyelesaian_surat_table = $('#sifat_penyelesaian_surat-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('sifat_penyelesaian_surat.index') }}",
        columns: [
    ...
    $('body').on('click', '.sifat_penyelesaian_surat-edit', function () {
        ...
        $.get("{{ route('sifat_penyelesaian_surat.index') }}" +'/' + sifat_penyelesaian_surat_id +'/edit', function (data) {
    ...
    $('#sifat_penyelesaian_surat-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "{{ route('sifat_penyelesaian_surat.store') }}",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.sifat_penyelesaian_surat-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('sifat_penyelesaian_surat.store') }}"+'/'+sifat_penyelesaian_surat_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
