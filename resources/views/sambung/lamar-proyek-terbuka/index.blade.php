        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Lamar Proyek Terbuka') }}</div>
...
<script type="text/javascript">
    ...
    var lamar_proyek_terbuka_table = $('#lamar_proyek_terbuka-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('lamar_proyek_terbuka.index') }}",
        columns: [
    ...
    $('body').on('click', '.lamar_proyek_terbuka-edit', function () {
        ...
        $.get("{{ route('lamar_proyek_terbuka.index') }}" +'/' + lamar_proyek_terbuka_id +'/edit', function (data) {
    ...
    $('#lamar_proyek_terbuka-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "{{ route('lamar_proyek_terbuka.store') }}",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.lamar_proyek_terbuka-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('lamar_proyek_terbuka.store') }}"+'/'+lamar_proyek_terbuka_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
