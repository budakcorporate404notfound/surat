        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Master Status') }}</div>
...
<script type="text/javascript">
    ...
    var master_status_table = $('#master_status-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('master_status.index') }}",
        columns: [
    ...
    $('body').on('click', '.master_status-edit', function () {
        ...
        $.get("{{ route('master_status.index') }}" +'/' + master_status_id +'/edit', function (data) {
    ...
    $('body').on('click', '.master_status-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('master_status.store') }}"+'/'+master_status_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
