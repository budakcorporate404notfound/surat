        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('File Proyek') }}</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="file_proyek-form" name="file_proyek-form"  method="POST"  role="form" enctype="multipart/form-data">
                    ...
                    @include('sambung.file-proyek.form')
...
<script type="text/javascript">
    ...
    $('body').on('click', '.file_proyek-edit', function () {
        ...
        $.get("{{ route('file_proyek.index') }}" +'/' + file_proyek_id +'/edit', function (data) {
    ...
    $('body').on('click', '.file_proyek-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('file_proyek.store') }}"+'/'+file_proyek_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
