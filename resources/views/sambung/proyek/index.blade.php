        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Proyek') }}</div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.proyek-edit', function () {
        ...
        $.get("{{ route('proyek.index') }}" +'/' + proyek_id +'/edit', function (data) {
    ...
    $('body').on('click', '.proyek-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('proyek.store') }}"+'/'+proyek_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
