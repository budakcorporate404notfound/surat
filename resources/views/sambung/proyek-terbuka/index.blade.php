        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Proyek Terbuka') }}</div>
...
<script type="text/javascript">
    ...
    var proyek_terbuka_table = $('#proyek_terbuka-data-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('proyek_terbuka.index') }}",
        columns: [
    ...
    $('body').on('click', '.proyek_terbuka-edit', function () {
        ...
        $.get("{{ route('proyek_terbuka.index') }}" +'/' + proyek_terbuka_id +'/edit', function (data) {
    ...
    $('#proyek_terbuka-save-btn').click(function (e) {
        ...
        $.ajax({
            ...
            url: "{{ route('proyek_terbuka.store') }}",
            type: "POST",
            dataType: 'json',
    ...
    $('body').on('click', '.proyek_terbuka-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('proyek_terbuka.store') }}"+'/'+proyek_terbuka_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
