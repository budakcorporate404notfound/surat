        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8" id="card_title">{{ __('Tahapan') }}</div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.tahapan-edit', function () {
        ...
        $.get("{{ route('tahapan.index') }}" +'/' + tahapan_id +'/edit', function (data) {
    ...
    $('body').on('click', '.tahapan-delete', function (){
        ...
        if(result){
            $.ajax({
                type: "DELETE",
                url: "{{ route('tahapan.store') }}"+'/'+tahapan_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
